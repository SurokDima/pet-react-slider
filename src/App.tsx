        ...
        <Layout>
          ...
          <Section title={'My title 1'} className={classes.section}>
            <p>
              ...
              tellus vitae sapien imperdiet, scelerisque tempus est ullamcorper.
              Quisque turpis turpis, pellentesque sit amet libero sed, accumsan
              varius ipsum. Nunc dictum turpis eu sapien auctor lobortis. In
              vehicula diam sit amet ipsum molestie condimentum. Cras
              consectetur turpis vel luctus hendrerit. Vivamus lacinia lacinia
              pharetra. Sed porta turpis non ex semper, ut rhoncus lectus
              efficitur. Vivamus dictum fermentum ante, non volutpat nisl
              laoreet eu. Quisque ac vehicula erat. Quisque elementum, mauris
              vitae ornare cursus, ipsum lorem aliquet lorem, id dignissim
              sapien nisi at tortor.
            </p>
            <Code>
              {`
<Carousel>
